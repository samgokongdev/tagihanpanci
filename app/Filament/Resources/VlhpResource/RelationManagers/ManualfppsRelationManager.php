...
class ManualfppsRelationManager extends RelationManager
{
    ...
    protected static ?string $recordTitleAttribute = 'Daftar Pemeriksa dan Kontribusi';
    protected static ?string $title = 'Daftar Pemeriksa dan Kontribusi';
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('k2')
                    ->label('Kontribusi Ang1'),
                Tables\Columns\TextColumn::make('ang2')
                    ->label('Anggota 2'),
                Tables\Columns\TextColumn::make('k3')
                    ->label('Kontribusi Ang2'),
